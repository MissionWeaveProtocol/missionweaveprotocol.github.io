...
完整狀態轉換和權限規則請閱讀規範性
[WorkItem 狀態機](../../../0.1/reference/specification/work-scheduling-and-recovery/#102-workitem-state-machine)
和
[基於 Evidence 的審查](../../../0.1/reference/specification/work-scheduling-and-recovery/#132-evidence-based-review)。
