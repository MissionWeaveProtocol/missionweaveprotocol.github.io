...
| [`lease.schema.json`](https://github.com/missionweaveprotocol/missionweaveprotocol/blob/main/schemas/lease.schema.json)                         | Erneuerbare, durch Epoch-Fencing gegen veraltete Ausführung abgesicherte Execution Lease           |
