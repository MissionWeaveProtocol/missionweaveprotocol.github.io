...
Fehler MUST `schemas/error.schema.json` entsprechen. Eine Fehlerantwort MUST
...
[Abschnitt 6.4](../signed-documents-and-trust/#mwp-sdv-015) nach. Das Bestehen
...
[Command und Event](../commands-events-and-ordering/#core-command-kinds) sowie
jede Übergangszeile in den
[Abschnitten 7.1](../missions-groups-and-membership/#mission-transition-table)
und [10.2](../work-scheduling-and-recovery/#workitem-transition-table) abdecken;
