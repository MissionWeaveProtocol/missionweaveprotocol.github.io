...
den exakten Protokoll-Commit sowie die Digests der implementierten Artifact.
...
| -------------------------------------------------------------------- | ------------------------------------ | ------------------ | ----------------------------- | --------------------------------------- |
| [Python](https://github.com/missionweaveprotocol/python-sdk)         | Vollständige Referenzimplementierung | Ja                 | 43/43 Vektoren                | Ja                                      |
| [Go](https://github.com/missionweaveprotocol/go-sdk)                 | Offizielles Protocol SDK             | Ja                 | 43/43 Vektoren                | Nein                                    |
| [TypeScript](https://github.com/missionweaveprotocol/typescript-sdk) | Offizielles Protocol SDK             | Ja                 | 43/43 Vektoren                | Nein                                    |
| [Java](https://github.com/missionweaveprotocol/java-sdk)             | Offizielles Protocol SDK             | Ja                 | 43/43 Vektoren                | Nein                                    |
| [Rust](https://github.com/missionweaveprotocol/rust-sdk)             | Offizielles Protocol SDK             | Ja                 | 43/43 Vektoren                | Nein                                    |
| [C++](https://github.com/missionweaveprotocol/cpp-sdk)               | Offizielles Protocol SDK             | Ja                 | 43/43 Vektoren                | Nein                                    |
...
Inhalts-IDs, Ed25519-Signaturen, Frame-Validierung sowie die 43 gepinnten
