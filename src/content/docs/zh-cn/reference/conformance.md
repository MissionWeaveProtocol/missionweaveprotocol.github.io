---
title: 符合性
description: 运行 56 个与实现无关的 MissionWeaveProtocol 符合性测试向量。
sidebar:
  label: 符合性
  order: 3
---

MissionWeaveProtocol 0.1 提供 **56 个与实现无关的符合性用例**：
...
| 无效     |   30 | [`conformance/vectors/invalid/`](https://github.com/missionweaveprotocol/missionweaveprotocol/tree/main/conformance/vectors/invalid) |
