...
Los errores MUST ajustarse a `schemas/error.schema.json`. Una respuesta de error
...
[Sección 6.4](../signed-documents-and-trust/#mwp-sdv-015). Superar
...
[anteriores](../commands-events-and-ordering/#core-command-kinds) y cada fila de
transición de las
