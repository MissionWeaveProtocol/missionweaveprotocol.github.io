...
title: Comandos, eventos y ordenamiento
description: >-
...
No es necesario que el JSON del protocolo llegue en el orden de miembros
canónicos, pero cada hash, identificador derivado del contenido o firma MUST usa
RFC 8785 JCS bytes. Los nombres de miembros de objetos duplicados MUST se
rechazarán antes de la validación del esquema. Los números y cadenas MUST
satisfacen las reglas finite-binary64 e I-JSON en la
[Sección 2](../foundations/#mwp-fnd-006); Las implementaciones conformes MUST
producen los mismos bytes JCS para el mismo valor JSON.
