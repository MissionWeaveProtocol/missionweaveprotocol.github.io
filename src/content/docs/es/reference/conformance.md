...
title: Conformidad
description:
  Ejecuta los 56 vectores de conformidad de MissionWeaveProtocol independientes
...
MissionWeaveProtocol 0.1 proporciona **56 casos de conformidad independientes de
la implementación**:

| Resultado esperado | Casos | Directorio canónico                                                                                                                  |
| ------------------ | ----: | ------------------------------------------------------------------------------------------------------------------------------------ |
| Válido             |    26 | [`conformance/vectors/valid/`](https://github.com/missionweaveprotocol/missionweaveprotocol/tree/main/conformance/vectors/valid)     |
| No válido          |    30 | [`conformance/vectors/invalid/`](https://github.com/missionweaveprotocol/missionweaveprotocol/tree/main/conformance/vectors/invalid) |
...
Ejecutar los 56 casos comprueba que una implementación coincide con las reglas
