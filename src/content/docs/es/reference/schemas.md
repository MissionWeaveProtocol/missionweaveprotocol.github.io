...
title: Esquemas JSON
description:
  Consulta los 21 Esquemas JSON normativos de MissionWeaveProtocol 0.1.
sidebar:
  label: Esquemas JSON
  order: 2
---
...
| [`lease.schema.json`](https://github.com/missionweaveprotocol/missionweaveprotocol/blob/main/schemas/lease.schema.json)                         | Execution Lease renovable con fencing por epoch frente a ejecuciones obsoletas                      |
