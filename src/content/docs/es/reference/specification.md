...
- [Especificación MissionWeaveProtocol 0.1](../../0.1/reference/specification/)
...
2. Lee la [especificación normativa](../../0.1/reference/specification/) para
   consultar los requisitos y las reglas del ciclo de vida.
