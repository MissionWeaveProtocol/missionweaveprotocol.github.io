...
The conformance command checks all 56 vendored vectors against the 21 vendored
...
For normative runtime semantics and cross-language integration guidance, use the
local [shared runtime reference](../../0.1/build/).
